...
To explore how ride distances vary between Cyclistic's casual and member riders and how these vary between weekdays and weekends, we conducted an analysis visualized through a bar chart. This allowed us to compare the average distances ridden by each rider type across different days of the week.

```{r ride_distance_plot, warning=FALSE, message=FALSE, echo=FALSE}
knitr::include_graphics(here("output", "plots", "ride_distance_mean.png"))
```
