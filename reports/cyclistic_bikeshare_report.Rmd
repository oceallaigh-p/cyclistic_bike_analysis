...
kintr::include_graphics(here("output", "plots", "bike_preference.png"))
```
...
```{r distance_duration_table, warning=FALSE, message=FALSE, echo=FALSE}
rider_stats %>%
  kable(
    caption = "Average ride distance and duration by rider type",
    format = "html"
  ) %>%
  custom_table_theme()
