...
knitr::include_graphics(here("resources", "images", "glimpse_raw.png"))
```
...
knitr::include_graphics(here("output", "plots", "ridership_ridertype_pie.png"))
```
...
knitr::include_graphics(here("output", "plots", "mean_distance_duration.png"))
```
...
knitr::include_graphics(here("output", "plots", "bike_preference.png"))
```
